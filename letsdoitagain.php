...
<html xmlns:fb="http://ogp.me/ns/fb#">
    <head>
        ...
        <link href="letsdocss.css" rel="stylesheet">
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
            ...
            <div class="container">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                     ...
                     <a href="profileview.php" class="navbar-brand"><img src="images/logo.png" height="25px" >People</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
					
					 <li class="active"><a href="http://localhost/ManiRoom/hand_made_js/new_status.php" id="NEW_STATUS">New</a></li>
	 ...
	 <div id="Profile">
 <!--message image    -->
 <a href="http://localhost/ManiRoom/hand_made_js/list_friends_message.php"  id="message_list"><span class="glyphicon glyphicon-envelope"></span></a>
    
    
<!--setting image-->
 
     
<a  href="#" id="notifications"  data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-cog"></span></a>
<!-- Modal -->
...
<div id="settings2">
  <a href="#" onClick="MyWindow=window.open('http://localhost/ManiRoom/profilepic.php','MyWindow','toolbar=no,location=no,directories=no,status=no, menubar=yes,scrollbars=no,resizable=no,width=600,height=600'); return false;">
      ...
      </span> <img src="get.php" height="30px;" width="30px;"></img></a>
</div>		
...
if($query_run =mysql_query("SELECT `first_name`, `last_name`, `username`  FROM `friend_list` WHERE `username`='".$row['username']."' "))
{
    ...
    while($row_result=mysql_fetch_assoc($query_run)) {
            echo '<a style="font-size:12px; " href="profile_search.php?search_text='.$row_result['username'].'">'.'<img src="Get_other_pic.php?search_text='.$row_result['username'].'" height="20px;" width="20px;"></img>';
